...
var benchmarkyearelements = document.getElementsByClassName("benchmarkyear");
for(var i=0;i < benchmarkyearelements.length;i++){
    benchmarkyearelements[i].innerText = window["report_options"].benchmarkyear;
}
