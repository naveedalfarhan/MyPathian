angular.module("pathianApp.controllers")
    .controller("tasktypesListCtrl", [
        ...
        function($scope, $rootScope, $location) {
            ...
            $scope.tasktypeGridOptions = $rootScope.global.getJsonGridOptions({
                        ...
                        command: [
                            {
                                ...
                                click: function (e) {
                                    ...
                                    $location.path("/admin/tasktypes/" + id + "/edit");
                                    $scope.$apply();
                                    return false;
                                }
                            },
                            {
                                ...
                                click: function(e){
                                    var id = $(e.currentTarget).closest("[kendo-grid]").data("kendoGrid").dataItem($(e.currentTarget).closest("tr")).id;
                                    $location.path("/admin/tasktypes/" + id + "/delete");
                                    $scope.$apply();
                                    return false;
                                }
                            }
                ...
                editable:false,
                createTemplate: "<a class='k-button k-button-icontext k-grid-add' href='\\#/admin/tasktypes/new'><span class='k-icon k-add'></span>Add new record</a>",
