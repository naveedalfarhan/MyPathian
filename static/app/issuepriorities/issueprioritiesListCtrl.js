angular.module("pathianApp.controllers")
    .controller("issueprioritiesListCtrl", [
        ...
        function($scope, $rootScope, $location) {
            ...
            $scope.issuepriorityGridOptions = $rootScope.global.getJsonGridOptions({
                controllerName: "IssuePriorities",
                model: {
                    id: "id",
                    fields: {
                        ...
                        command: [
                            {
                                ...
                                click: function (e) {
                                    ...
                                    $location.path("/admin/issuepriorities/" + id + "/edit");
                                    $scope.$apply();
                                    return false;
                                }
                            },
                            {
                                ...
                                click: function(e){
                                    var id = $(e.currentTarget).closest("[kendo-grid]").data("kendoGrid").dataItem($(e.currentTarget).closest("tr")).id;
                                    $location.path("/admin/issuepriorities/" + id + "/delete");
                                    $scope.$apply();
                                    return false;
                                }
                            }
                ...
                editable:false,
                createTemplate: "<a class='k-button k-button-icontext k-grid-add' href='\\#/admin/issuepriorities/new'><span class='k-icon k-add'></span>Add new record</a>",
