...
class TaskStatusRepository:
    def __init__(self, uow):
        self.uow = uow
        self.table = uow.tables.taskstatuses

    def get_all_taskstatuses(self, query_parameters):
    ...
    def does_task_status_exist_by_name(self, name):
